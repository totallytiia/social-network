		...
		<>
			<div className="ml-8 mr-6 my-2">
				<form
					...
					action="">
					<input className="bg-gray-50 px-4 text-sm outline-none rounded-full w-full"
						type="text"
						id="commentBox"
					...
					<label className="my-auto cursor-pointer" htmlFor="commentSubmit">
						<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="gray" className="w-5 h-5 ml-1 my-auto">
