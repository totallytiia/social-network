...
export default function Profile() {
    ...
    // get user's posts
    const [ownPosts, setOwnPosts] = useState([] as IPost[]);

    useEffect(() => {
        async function getPosts() {
            if (userData.id === undefined) return;
            const url = `http://localhost:8080/api/posts/get?user_id=${userData.id}`;
            ...
            <div className="p-16 bg-custom z-0 item-center justify-center">
                <div className="p-10 shadow-xl flex flex-col items-center bg-white rounded-xl">
                    ...
                    <div className="mt-12 flex flex-col justify-center">
                        ...
                        {ownPosts !== undefined && ownPosts.length !== 0 ? (
